...
4. The Option for Integrated Logins has been removed - it hasn't worked in several years.
...
7. A comprehensive step by step is contained on the [TNG Wiki](https://tng.lythgoes.net/wiki/index.php?title=Using_TNG_and_WordPress_with_the_tng-wordpress-plugin)
