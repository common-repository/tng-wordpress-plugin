...
Updated by: Darrin Lythgoe and Roger Moffat, 2011-2022
Version: 10.1.4
Author URI: 
Copyright (c) 2008 Mark Barnes 2011-2022 Darrin Lythgoe and Roger Moffat
...
// Next block removed to stop crash with Integrated Logins
//	echo "\t\t<tr>\n";
...
//		echo "\t\t</tr>\n";
//}
// End block removed to stop crash with Integrated Logins
	update_option('mbtng_integrate_logins', ""); // to unset the setting if it it has been set
	echo "\t\t<tr>\n";
...
// Roger - if you want to over-ride these styles, copy these lines to mytngstyle.css and change them there
	$tng_head = "<!-- TNG-WordPress-Plugin v10.1.4 -->
	<style type=\"text/css\">
